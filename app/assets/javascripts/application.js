...
$(document).ready(() => {
  ...
  $('input.js-light-dark-toggle').change(function(e) {
    if ($(this).prop('checked') == true) { // DARK MODE
      ...
      $('.center-column article').addClass('white-text')
      $('.center-column div').addClass('white-text')
      $('.center-column').addClass('dark-bg')
      $('.right-column').addClass('dark-bg')
      $('.typeahead-dropdown').removeClass('white-text')
      $('.typeahead-dropdown').addClass('black-text')
